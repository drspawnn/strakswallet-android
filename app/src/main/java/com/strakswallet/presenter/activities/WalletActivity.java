...
import com.strakswallet.tools.manager.TxManager;
...
import static com.strakswallet.tools.animation.BRAnimator.t1Size;
import static com.strakswallet.tools.animation.BRAnimator.t2Size;
...
//            BRSharedPrefs.putBchDialogShown(WalletActivity.this, true);
    ...
    // If it is, notify the user that the STRAKS app will not function properly and they should
    // disable it
