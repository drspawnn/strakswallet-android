...
import com.strakswallet.presenter.activities.CurrencySettingsActivity;
...
import com.strakswallet.presenter.entities.BRSettingsItem;
...
import static com.strakswallet.R.layout.settings_list_item;
import static com.strakswallet.R.layout.settings_list_section;
    ...
    private void populateItems() {
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_bitcoin), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BRSharedPrefs.putCurrentWalletIso(app, "STAK"); //change the current wallet to the one they enter settings to
                startActivity(intent);
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
        ...
        */
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_review), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent appStoreIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "com.strakswallet"));
                    appStoreIntent.setPackage("com.android.vending");

                    startActivity(appStoreIntent);
                } catch (android.content.ActivityNotFoundException exception) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + "com.strakswallet")));
                }
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
